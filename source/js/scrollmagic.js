...
/*
	 ...
	 */
		 ...
		 * It then updates the current scene state accordingly (or does nothing, if the state is already correct) тАУ Pins will be set to their correct position and tweens will be updated to their correct progress.  
		 ...
		 * @param {mixed} [additionalParameter] - If a custom scroll function was defined (see above 4.), you may want to supply additional parameters to it, when calling it. You can do this using this parameter тАУ see examples for details. Please note, that this parameter will have no effect, if you use the default scrolling function.
		 * @returns {Controller} Parent object for chaining.
		 */
 ...
 */
	...
	var _util = ScrollMagic._util = (function (window) {
		...
		// extend obj тАУ same as jQuery.extend({}, objA, objB)
